                                ...
                                <div class="product product-2">
                                    <figure class="product-media">
                                        <a href="/products/{{ $product->slug }}">
                                            <img src="{{ asset($product->images[0]->url)  }}" alt="Product image" class="product-image">
                                        </a>
                            ...
                            <div class="col-6 col-md-4 col-xl-3">
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('assets/images/demos/demo-13/cats/cat-page/7.jpg') }}" alt="Product image" class="product-image">
                                        </a>
