...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $head->mobileTitle }}">
    <meta name="application-name" content="{{ $head->appName }}">
        ...
        <div class="header-top">
            <div class="container">
                <div class="header-left">
                    <a href="tel:#"><i class="icon-phone"></i>Call: </a>
                </div><!-- End .header-left -->
                    ...
                    <div class="wishlist">
                        <a href="/wishlist" title="Wishlist">
                            <div class="icon">
                                ...
                                @if(Auth::user())
                                <span class="wishlist-count badge">{{ $head->countWishlist }}</span>
                                @endif
                            </div>
                            <p>Wishlist</p>
                        </a>
                                ...
                                <ul class="menu-vertical sf-arrows">
                                    @isset($categories)
                                        @foreach($categories as $category)
                                            <li class="{{ $category->is_recommended ? 'item-lead' : '' }}"><a href="#">{{ $category->name }}</a></li>
                                        @endforeach
                                    @endisset
